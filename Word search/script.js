...
const gridSize=11;//10x10 grid
const letters="ABCDEFGHIJKLMNOPQRSTUVWXYZ";
const words=["BJC","LIONPAW","WHITEOUT","HUBROBESON","POLLOCK","CREAMERY","THON","CANVAS","BLUEBAND","LIBRARY","GRADUATION","FOOTBALL"];
...
const lwords=[["BJC","LIONPAW","WHITEOUT","HUBROBESON"],["POLLOCK","CREAMERY","THON","CANVAS"],["BLUEBAND","LIBRARY","GRADUATION","FOOTBALL"]];
